...
public class StateExcelOrange {
	...
	public StateExcelOrange(List<OrangeExcel> listDetailsArtistes)
	{
	...
	private void writeHeaderLine()
	{
		...
		createCell(row,7,"Htva",style);
		createCell(row,8,"Part Artiste",style);
