...
private XSSFWorkbook workbook ;
	...
	public StateTotalTTById(List<TTExcel> listDetailsArtistes)
	{
	...
	private void writeHeaderLine()
	{
		...
		createCell(row,6,"Revenu Global Smart",style);
		createCell(row,7,"Htva/PartCp",style);
