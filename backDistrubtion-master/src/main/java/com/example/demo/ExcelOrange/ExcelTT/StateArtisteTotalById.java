...
public class StateArtisteTotalById {
...
private XSSFWorkbook workbook ;
	...
	public StateArtisteTotalById(List<TTExcel> listDetailsArtistes)
	{
	...
	private void writeHeaderLine()
	{
		...
		createCell(row,5,"Revenu Global cp",style);
		createCell(row,6,"Htva/PartCp",style);
