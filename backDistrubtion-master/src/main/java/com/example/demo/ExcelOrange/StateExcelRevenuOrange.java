...
public class StateExcelRevenuOrange {
...
private XSSFWorkbook workbook ;
	...
	public StateExcelRevenuOrange(List<OrangeExcel> listDetailsArtistes)
	{
	...
	private void writeHeaderLine()
	{
		...
		createCell(row,8,"Htva",style);
		createCell(row,9,"Part Artiste",style);
