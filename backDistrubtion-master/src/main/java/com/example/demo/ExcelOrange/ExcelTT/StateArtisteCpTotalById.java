...
public class StateArtisteCpTotalById {
...
private XSSFWorkbook workbook ;
	...
	public StateArtisteCpTotalById(List<TTExcel> listDetailsArtistes)
	{
	...
	private void writeHeaderLine()
	{
		...
		style.setFont(font);
		createCell(row,0,"Date debu",style);
		createCell(row,1,"Date Fin",style);
		
		createCell(row,2,"Nom Chanson",style);
		createCell(row,3,"Nom Artiste",style);
		createCell(row,4,"Nombre d'ecoute",style);
		//createCell(ro,4,"Revenu Golbal Operation",style);
