...
private XSSFWorkbook workbook ;
	...
	public StateTotalTT(List<TTExcel> listDetailsArtistes)
	{
	...
	private void writeHeaderLine()
	{
		...
		createCell(row,4,"Tax Telecome",style);
		createCell(row,5,"Total Net de redvance",style);
		createCell(row,6,"Revenu Golbal Smart",style);
		
		createCell(row,7,"Revenu Global Smart",style);
		createCell(row,8,"Htva/PartCp",style);
