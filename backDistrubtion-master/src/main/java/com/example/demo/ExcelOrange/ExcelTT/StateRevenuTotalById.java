...
public class StateRevenuTotalById {
...
private XSSFWorkbook workbook ;
	...
	public StateRevenuTotalById(List<TTExcel> listDetailsArtistes)
	{
	...
	private void writeDataLine ()
	{
		...
		for(TTExcel det : detailsArtistes)
		{
			...
			createCell(row,columnCount++,det.getContentProvider(), style);
