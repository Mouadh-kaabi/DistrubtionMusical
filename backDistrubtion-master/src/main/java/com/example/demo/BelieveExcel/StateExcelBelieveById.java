...
public class StateExcelBelieveById {
	...
	public StateExcelBelieveById(List<BelieveExcel> listDetailsArtistes) {
	...
	private void writeHeaderLine() {
		...
		createCell(row, 3, "Revenu Golbal Smart", style);

		createCell(row, 4, "Part Artiste", style);
