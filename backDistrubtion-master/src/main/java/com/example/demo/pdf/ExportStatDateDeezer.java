...
@Service
public class ExportStatDateDeezer {

	
	public static ByteArrayInputStream StateDatePdfReport(List<DeezerExcel> details)
	{
	...
	public static ByteArrayInputStream StateDatePdfReportById(List<DeezerExcel> details)
	{
	...
	public static ByteArrayInputStream StateArtistePdfReport(List<DeezerExcel> details)
	{
	...
	public static ByteArrayInputStream StateArtistePdfReportById(List<DeezerExcel> details)
	{
		...
		try {
			...
			//make column titre 
			Stream.of("Nom Artiste","Nombre d'ecoute","Part Artiste").forEach(headerTitle->{
				PdfPCell header = new PdfPCell();
				com.itextpdf.text.Font headfont = FontFactory.getFont(FontFactory.HELVETICA_BOLDOBLIQUE);
	...
	public static ByteArrayInputStream StateChansonPdfReport(List<DeezerExcel> details)
	{
	...
	public static ByteArrayInputStream StateChansonPdfReportById(List<DeezerExcel> details)
	{
	...
	public static ByteArrayInputStream StatePlatformePdfReport(List<DeezerExcel> details)
	{
	...
	public static ByteArrayInputStream StateRevenuPdfReport(List<DeezerExcel> details)
	{
		...
		try {
			...
			//make column titre 
			Stream.of("Nom Artiste","Date Début","Date Fin","Nombre d'ecoute","Revenu global Op (Eur)","Revenu global Op (Tnd)","Revenu Global Smart","Part Artiste").forEach(headerTitle->{
				PdfPCell header = new PdfPCell();
				com.itextpdf.text.Font headfont = FontFactory.getFont(FontFactory.HELVETICA_BOLDOBLIQUE);
			...
			for(DeezerExcel det : details)
			{
				...
				//date1
				PdfPCell dateCell4 = new PdfPCell (new Phrase (String.valueOf(det.getNamea())));
				...
				//Date fin 
				PdfPCell dateCell2 = new PdfPCell( new Phrase (String.valueOf(det.getDate2())));
				dateCell2.setPaddingLeft(1);
				dateCell2.setVerticalAlignment(Element.ALIGN_MIDDLE);
				dateCell2.setHorizontalAlignment(Element.ALIGN_LEFT);
				table.addCell(dateCell2);
				
				
				//date1
				PdfPCell dateCell = new PdfPCell (new Phrase (String.valueOf(det.getQuantite())));
				dateCell.setPadding(-1);
				//dateCell.setPaddingRight(0);
				dateCell.setVerticalAlignment(Element.ALIGN_CENTER);
				dateCell.setHorizontalAlignment(Element.ALIGN_TOP);
	...
	public static ByteArrayInputStream StateRevenuPdfReportById(List<DeezerExcel> details)
	{
	...
	public static ByteArrayInputStream StateDateCpPdfReport(List<DeezerExcel> details)
	{
		...
		try {
			...
			//make column titre 
			Stream.of("Date Début","Date fin","Nombre d'ecoute","Revenu global Op","Revenu global Eur","Revenu Global Smart","Part CP").forEach(headerTitle->{
				PdfPCell header = new PdfPCell();
				com.itextpdf.text.Font headfont = FontFactory.getFont(FontFactory.HELVETICA_BOLDOBLIQUE);
			...
			for(DeezerExcel det : details)
			{
				...
				PdfPCell revnuglobal1 = new PdfPCell(new Phrase (String.valueOf(det.getTTC_EUR())));
				revnuglobal1.setPaddingLeft(2);
				revnuglobal1.setVerticalAlignment(Element.ALIGN_MIDDLE);
				revnuglobal1.setHorizontalAlignment(Element.ALIGN_LEFT);
				table.addCell(revnuglobal1);
	...
	public static ByteArrayInputStream StateChansonCpPdfReport(List<DeezerExcel> details)
	{
		...
		try {
			...
			//make column titre 
			Stream.of("Date Début","Date fin","Nom Artiste","Nom Chanson","Nombre d'ecoute","Revenu global Eur","Revenu global Op Tnd","Revenu Global Smart","Part CP").forEach(headerTitle->{
				PdfPCell header = new PdfPCell();
				com.itextpdf.text.Font headfont = FontFactory.getFont(FontFactory.HELVETICA_BOLDOBLIQUE);
			...
			for(DeezerExcel det : details)
			{
				...
				PdfPCell nomAr = new PdfPCell(new Phrase(String.valueOf( det.getNamea())));
				nomAr.setPaddingLeft(2);
				nomAr.setVerticalAlignment(Element.ALIGN_MIDDLE);
				nomAr.setHorizontalAlignment(Element.ALIGN_LEFT);
				table.addCell(nomAr);
				
				PdfPCell nomCo = new PdfPCell(new Phrase(String.valueOf( det.getContent())));
				nomCo.setPaddingLeft(2);
				nomCo.setVerticalAlignment(Element.ALIGN_MIDDLE);
				nomCo.setHorizontalAlignment(Element.ALIGN_LEFT);
				table.addCell(nomCo);
	...
	public static ByteArrayInputStream StatePaysPdfReport(List<DeezerExcel> details)
	{
		...
		try {
			...
			//make column titre 
			Stream.of("Pays","Nombre d'ecoute","Revenu global Op (Eur)","Revenu global Op (Tnd)","Revenu Global Smart","Part Artiste").forEach(headerTitle->{
				PdfPCell header = new PdfPCell();
				com.itextpdf.text.Font headfont = FontFactory.getFont(FontFactory.HELVETICA_BOLDOBLIQUE);
			...
			for(DeezerExcel det : details)
			{
				...
				//date1
				PdfPCell dateCell = new PdfPCell (new Phrase (String.valueOf(det.getPays())));
				dateCell.setPadding(-1);
				//dateCell.setPaddingRight(0);
				dateCell.setVerticalAlignment(Element.ALIGN_CENTER);
				dateCell.setHorizontalAlignment(Element.ALIGN_TOP);
