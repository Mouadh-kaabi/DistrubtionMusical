...
public class StateRevenuExcelDeezerById {
	...
	public StateRevenuExcelDeezerById(List<DeezerExcel> listDetailsArtistes) {
	...
	private void writeHeaderLine() {
		...
		createCell(row, 1, "Date début", style);
		createCell(row, 2, "Date Fin", style);
		createCell(row, 3, "Nombre d'ecoute", style);
		//createCell(row, 4, "Revenu Golbal Operation", style);
		//createCell(row, 5, "Revenu Golbal Operation Eur", style);
